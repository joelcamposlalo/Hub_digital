...
class Dictamen_finca_antigua extends Controller
{
    function Conectarse()
    {
    ...
    {
        if ($folio = Dictamen_finca_antigua_model::solicitud()) {
    ...
    {
        if ($response = Dictamen_finca_antigua_model::ingresa_solicitud($request)) {
            $obj = $response[0];
