...
@section('container')
<h1 class="text-muted font m-0 bold c-primary-color">Trabajos menores @isset($id_captura)@endisset</h1>
    ...
    <div class="col-md-9">
        <div class="etapas d-flex justify-content-center align-items-center">
            <div style="width: 60px;" class="d-flex flex-column justify-content-center align-items-center">
                <div class="etapa border @if($id_etapa == 1) active @else process @endif d-flex justify-content-center align-items-center">
                    @if($id_etapa == 1)
                    ...
                    @endif
                    <small class="font f-15 bold @if($id_etapa == 1) text-white @else text-muted @endif">1</small>
                </div>
            ...
            <div style="width: 60px; transform: translateY(7px);" class="d-flex flex-column justify-content-center align-items-center">
                <div class="etapa  @if($id_etapa == 2 or $id_etapa == 3 or $id_etapa == 6) active text-white @else process @endif  border d-flex justify-content-center align-items-center">
                    @if($id_etapa == 2 or $id_etapa == 3 or $id_etapa == 6)
                    <div class="success d-flex justify-content-center align-items-center">
                        <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-check2 bold text-white" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" d="M13.854 3.646a.5.5 0 0 1 0 .708l-7 7a.5.5 0 0 1-.708 0l-3.5-3.5a.5.5 0 1 1 .708-.708L6.5 10.293l6.646-6.647a.5.5 0 0 1 .708 0z" />
                        </svg>
                    ...
                    @endif
                    <small class="font f-15 bold @if($id_etapa == 2 or $id_etapa == 3 or $id_etapa == 6) text-white @else text-muted @endif ">2</small>
                </div>
                <small class="mt-1 mb-1 font c-carbon f-10 text-center">Adjuntar requisitos</small>
            </div>
            <div class="line"></div>
            <div style="width: 60px; transform: translateY(7px);" class="d-flex flex-column justify-content-center align-items-center">
                <div class="etapa  @if($id_etapa == 18) active @else process @endif border d-flex justify-content-center align-items-center">
                    @if($id_etapa == 18)
                    <div class="success d-flex justify-content-center align-items-center">
                        <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-check2 bold text-white" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" d="M13.854 3.646a.5.5 0 0 1 0 .708l-7 7a.5.5 0 0 1-.708 0l-3.5-3.5a.5.5 0 1 1 .708-.708L6.5 10.293l6.646-6.647a.5.5 0 0 1 .708 0z" />
                    ...
                    @endif
                    <small class="font f-15 bold @if($id_etapa == 18) text-white @else text-muted @endif">3</small>
                </div>
            ...
            <div style="width: 60px;" class="d-flex flex-column justify-content-center align-items-center">
                <div class="etapa  @if($id_etapa == 18) active @else process @endif border d-flex justify-content-center align-items-center">
                    ...
                    @endif
                    <small class="font f-15 bold @if($id_etapa == 18) text-white @else text-muted @endif">4</small>
                </div>
                    ...
                    <div class="responsive w-100" style="width: 100%; overflow-x: auto;">
                        <table class="w-100">
                            ...
                            <tr class="w-100 predio">
                                ...
                                @if($predio->cuenta_predial != '')<td class="f-12 font">Cuenta:
                                    {{$predio->cuenta_predial}}
                                </td>@endif
            ...
            <div class="card-body">
                <form id=form_2 method="post">
                    ...
                    <div class="alert alert-warning alert-dismissible fade show" role="alert">
                        <strong class="f-11">Nota:</strong> <small class="f-11">Escribe la cuenta o en su defecto la
                            CURT y luego da click en Buscar predio. Sí alguno de los datos esta incorrecto por favor
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mt-2">
                            ...
                            <input name="letraI" id="letraI" value="{{((isset($LetraI))?$LetraI:'')}}" class="ab-form background-color rounded border capitalize LetraI" type="text" maxlength="5" style="text-transform: uppercase;">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mt-2">
                ...
                <form id=form_3 method="post">
                    ...
                    <div class="row">
                        <div class="col-md-8 mt-2">
                            ...
                            <input name="correo_propietario" id="correo_propietario" class="ab-form background-color rounded border correo_propietario" type="text" value="{{((isset($correo_propietario))?$correo_propietario:'')}}" required>
                        </div>
    ...
    <div class="col-md-9 mt-4" id="top-4">
        <div class="card  shadow-sm card_4 rounded border-none">
            ...
            <div class="card-body">
                ...
                <form id="form_4" action="{{url('trabajos_menores/ingresa_tramite')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="responsive w-100" style="width: 100%; overflow-x: auto;">
                        <table class="w-100">
...
<script>
    ...
    $(document).ready(function() {
        ...
        @if(isset($id_etapa) && ($id_etapa == 2))
        $('.card_1 .card-body').slideUp('slow');
        $('.card_3 .card-body').slideDown('slow');
        $('.continuar').fadeIn();
        @elseif(isset($id_etapa) && ($id_etapa == 3))
        $('.card_1 .card-body').slideUp('slow');
        $('.card_4 .card-body').slideDown('slow');
        $('.continuar').fadeIn();
        @endif
        ...
        $('#form_3').submit(async function(e) {
            ...
            if (id_solicitud > 0) {
                ...
                if ($('#id_captura').val() == "") {
                    ...
                    var res = await axios.post('{{url("trabajos_menores/ingresa_solitud")}}',
                        formdata, {
                            data: {
                                "_token": "{{ csrf_token() }}"
                            }
                    ...
                    var res = await axios.post('{{url("trabajos_menores/actualiza_solitud")}}',
                        formdata, {
                            data: {
                                "_token": "{{ csrf_token() }}"
                            }
