...
<body class="background-color">
    ...
    <div class="contenedor border shadow-sm">
        <form id="form" action="{{url('cuenta/recuperar')}}" method="post" class="left">
            <h2 class="font font-500" style="color: #090910;">Cambia tu contraseña</h4>
                @csrf
                ...
                <input type="email" name='correo' class="background-color rounded border" placeholder="Correo" required>
                 <!-- ReCaptcha -->
            {!! RecaptchaV3::initJs() !!}
            ...
            @enderror
				<button type="submit" class="b-primary-color text-white font rounded">Enviar</button>
                <a href="{{url('cuenta')}}" class="f-13 mt-1">Regresar</a>
                <a href="{{url('cuenta/registrof')}}" class="f-13 mt-1">¿Aún no tienes cuenta? Regístrate</a>
        </form>
        <div class="right b-primary-color">
            <img src="{{asset('media/ilustrator/recupera.svg')}}" width="200px" alt="recuperar contraseña">
            <h4 class="font text-white text-center mt-4">¿Olvidaste tu contraseña?</h4>
            <small class="text-center text-white font">Es fácil crear una nueva. Solo ingresa tu dirección de correo electrónico y da click en Enviar. </small>
        </div>
    </div>
