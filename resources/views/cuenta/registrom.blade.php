...
<body class="background-color">
    ...
    <div class="contenedor border shadow-sm">
        <form id="form" action="{{url('cuenta/registrarm')}}" method="post" class="left">
            <h2 class="font font-500" style="color: #090910;">Crear cuenta</h4>
                <span class="badge badge-pill badge-warning">Empresa o Institución</span>
                @csrf
            ...
            @enderror
                ...
                <a href="{{url('cuenta/registrof')}}" class="f-13 mt-2">Soy un ciudadano</a>
                <a href="{{url('cuenta')}}" class="f-13">Iniciar sesión</a>

        </form>
        <div class="right b-primary-color">
            <img src="{{asset('media/ilustrator/registrom.svg')}}" width="200px" alt="registro de empresa">
