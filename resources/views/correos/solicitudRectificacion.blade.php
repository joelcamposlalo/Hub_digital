                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                <td style="line-height: 24px; font-size: 16px; margin: 0;"
                                                                                    align="left">
                                                                                    <img class="w-32"
                                                                                        src="https://pagos.zapopan.gob.mx/PagoEnLinea/img/logo-zapopan.b7fa7851.png"
                                                                            ...
                                                                            <tr>
                                                                                <td style="line-height: 24px; font-size: 16px; margin: 0;"
                                                                                    ...
                                                                                    <img class="max-w-56  rounded-lg"
                                                                                        src="https://cdn-icons-png.flaticon.com/512/2720/2720583.png"
                                                                            ...
                                                                            <tr>
                                                                                <td style="line-height: 24px; font-size: 16px; margin: 0;"
                                                                                    ...
                                                                                    <p class="max-w-96 lh-lg text-white text-center text-2xl"
                                                                                        ...
                                                                                        necesitas para la rectificación
                                                                                    </p>
                                                                                </td>
                                                                            </tr>
                                                                        </tbody>
                                                ...
                                                <td style="line-height: 24px; font-size: 16px; margin: 0;"
                                                    ...
                                                    <div
                                                        ...
                                                        {{-- @foreach ($document_urls as $filename => $url)
                                                            <p>Enlaces a la documentación de solicitantes
                                                                <a href="{{ $url }}">{{ $url }}</a>
                                                            </p>
                                                        @endforeach --}}
