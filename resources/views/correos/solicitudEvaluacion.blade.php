                                                                            ...
                                                                            <tr>
                                                                                <td style="line-height: 24px; font-size: 16px; margin: 0;"
                                                                                    ...
                                                                                    <img class="max-w-56  rounded-lg"
                                                                                        src="https://cdn-icons-png.flaticon.com/512/8347/8347392.png"
                                            ...
                                            <tr>
                                                <td style="line-height: 24px; font-size: 16px; margin: 0;"
                                                    ...
                                                    <div
                                                        ...
                                                        <p><b>Con régimen fiscal de </b> {{ $correoData->personaJ }}</p>
                                                        ...
                                                        <p>Enlace a la Evidencia de Evaluación de Riesgos
                                                            <a href="{{ $url }}">{{ $url }}</a>
                                                        </p>
                                                    @endforeach
