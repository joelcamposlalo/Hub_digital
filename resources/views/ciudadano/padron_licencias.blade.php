...
@section('title', 'Padrón y Licencias')
...
<div class="container position-relative" style="padding: 0 !important">
    <div class="d-flex align-items-center">
        ...
        <h1 class="text-muted font m-0 bold c-primary-color">Dirección de Padrón y Licencias</h1>
    </div>
...
<div id="section">
    <div class="row">
        ...
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mt-4 card-tramite">
            <a style="text-decoration: none; color: gray;" href="https://portal.zapopan.gob.mx/otras_consultas/cat_giros.asp">
                <div style="height: 260px;" class="card card-hover-effect">
                    <div class="card-body d-flex flex-column justify-content-center align-items-center">
                        <div style="height: 110px" class="d-flex flex-column justify-content-center align-items-center">
                            ...
                            <span class="badge badge-warning mt-4">Catálogo de giros</span>
                        </div>
                        <div style="height: 150px" class="d-flex flex-column justify-content-center align-items-center">
                            <small class="text-center mt-2">Conoce los requisitos para tu trámite</small>
        ...
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mt-4 card-tramite">
            <a style="text-decoration: none; color: gray;" href="https://pagos.zapopan.gob.mx/PortalCiudadano/Recaudacion/Licencias/ImpresionLicencia.aspx">
                <div style="height: 260px;" class="card card-hover-effect">
                    <div class="card-body d-flex flex-column justify-content-center align-items-center">
                        <div style="height: 110px" class="d-flex flex-column justify-content-center align-items-center">
                            <img src="{{asset('media/ilustrator/giro_comercial.svg')}}" width="120px" alt="dirección de padrón y licencias" aria-hidden="true">
                            <span class="badge badge-warning mt-4">Impresión de Licencia</span>
                        </div>
                        <div style="height: 150px" class="d-flex flex-column justify-content-center align-items-center">
                            <small class="text-center mt-2">Aquí puedes imprimir tu Licencia Municipal</small>
                            <div style="width: 50px; height: 50px; background-color: #ffc107; border-radius: 50%;" class="circle mt-4 d-flex justify-content-center align-items-center">
                                <i class="fas fa-arrow-right text-white"></i>
                            </div>
                        </div>
        ...
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mt-4 card-tramite">
            <a style="text-decoration: none; color: gray;" href="https://www.zapopan.gob.mx/unidad-de-verificacion-multifuncional/">
                <div style="height: 260px;" class="card card-hover-effect">
                    <div class="card-body d-flex flex-column justify-content-center align-items-center">
                        <div style="height: 110px" class="d-flex flex-column justify-content-center align-items-center">
                            <img src="{{asset('media/ilustrator/giro_comercial.svg')}}" width="120px" alt="dirección de padrón y licencias" aria-hidden="true">
                            <span class="badge badge-warning mt-4">Verificadores</span>
                        </div>
                        <div style="height: 150px" class="d-flex flex-column justify-content-center align-items-center">
                            <small class="text-center mt-2">Personal que labora en el área de vereficación</small>
                            <div style="width: 50px; height: 50px; background-color: #ffc107; border-radius: 50%;" class="circle mt-4 d-flex justify-content-center align-items-center">
                                <i class="fas fa-arrow-right text-white"></i>
                            </div>
                        </div>
        ...
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mt-4 card-tramite">
            <a style="text-decoration: none; color: gray;" href="http://linea.zapopan.gob.mx/users/sign_in">
                <div style="height: 260px;" class="card card-hover-effect">
                    <div class="card-body d-flex flex-column justify-content-center align-items-center">
                        <div style="height: 110px" class="d-flex flex-column justify-content-center align-items-center">
                            <img src="{{asset('media/ilustrator/giro_comercial.svg')}}" width="120px" alt="dirección de padrón y licencias" aria-hidden="true">
                        ...
                        <div style="height: 150px" class="d-flex flex-column justify-content-center align-items-center">
                            <small class="text-center mt-2">Licencias "A", "B" y "C"</small>
                            <div style="width: 50px; height: 50px; background-color: #ffc107; border-radius: 50%;" class="circle mt-4 d-flex justify-content-center align-items-center">
                                <i class="fas fa-arrow-right text-white"></i>
                            </div>
                        </div>
        ...
        <!-- <div id=carta class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mt-4 card-tramite" data-tramite='Licencia comercial' data-img="giro_comercial.svg" data-url="licencias/solicitud">
            <a style="text-decoration: none; color: gray;" href="#!" data-toggle="modal" data-target="#modal-carta">
                <div style="height: 260px;" class="card card-hover-effect">
                    <div class="card-body d-flex flex-column justify-content-center align-items-center">
                        ...
                        <div style="height: 150px" class="d-flex flex-column justify-content-center align-items-center">
                            <small class="text-center mt-3">Licencia "A", "B" y "C"</small>
                            <div style="width: 50px; height: 50px; background-color: #ffc107; border-radius: 50%;" class="circle mt-4 d-flex justify-content-center align-items-center">
                                <i class="fas fa-arrow-right text-white"></i>
                            </div>
                        </div>
        ...
        <div id=carta class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mt-4 card-tramite" data-tramite='Prelicencia' data-img="giro_comercial.svg" data-url="prelicencias/solicitud">
            <a style="text-decoration: none; color: gray;" href="#!" data-toggle="modal" data-target="#modal-carta">
                <div style="height: 260px;" class="card card-hover-effect">
                    <div class="card-body d-flex flex-column justify-content-center align-items-center">
                        <div style="height: 110px" class="d-flex flex-column justify-content-center align-items-center">
                        ...
                        <div style="height: 150px" class="d-flex flex-column justify-content-center align-items-center">
                            <small class="text-center mt-3">Prelicencia</small>
                            <div style="width: 50px; height: 50px; background-color: #ffc107; border-radius: 50%;" class="circle mt-4 d-flex justify-content-center align-items-center">
                                <i class="fas fa-arrow-right text-white"></i>
                            </div>
                        </div>
        ...
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mt-4 card-tramite">
            <a style="text-decoration: none; color: gray;" href="https://servicios.zapopan.gob.mx:8000/wwwportal/publicfiles/2020-01/FormatoMultipleC.pdf">
                <div style="height: 260px;" class="card card-hover-effect">
                    <div class="card-body d-flex flex-column justify-content-center align-items-center">
                        <div style="height: 110px" class="d-flex flex-column justify-content-center align-items-center">
                            <img src="{{asset('media/ilustrator/giro_comercial.svg')}}" width="120px" alt="dirección de padrón y licencias" aria-hidden="true">
                            <span class="badge badge-warning mt-4">Formato múltiple</span>
                        </div>
                        <div style="height: 150px" class="d-flex flex-column justify-content-center align-items-center">
                            <small class="text-center mt-2">Descarga el formato para trámites de Pádron y Licencia</small>
                            <div style="width: 50px; height: 50px; background-color: #ffc107; border-radius: 50%;" class="circle mt-4 d-flex justify-content-center align-items-center">
                                <i class="fas fa-arrow-right text-white"></i>
                            </div>
                        </div>
        ...
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mt-4 card-tramite">
            <a style="text-decoration: none; color: gray;" href="https://portal.zapopan.gob.mx/pyl/permisos/Login.asp">
                <div style="height: 260px;" class="card card-hover-effect">
                    <div class="card-body d-flex flex-column justify-content-center align-items-center">
                        <div style="height: 110px" class="d-flex flex-column justify-content-center align-items-center">
                            <img src="{{asset('media/ilustrator/giro_comercial.svg')}}" width="120px" alt="dirección de padrón y licencias" aria-hidden="true">
                            <span class="badge badge-warning mt-4">Permisos extraordinarios</span>
                        </div>
                        <div style="height: 150px" class="d-flex flex-column justify-content-center align-items-center">
                            <small class="text-center mt-2">Permisos extraordinarios para horas extras</small>
                            <div style="width: 50px; height: 50px; background-color: #ffc107; border-radius: 50%;" class="circle mt-4 d-flex justify-content-center align-items-center">
                                <i class="fas fa-arrow-right text-white"></i>
                            </div>
                        </div>
        ...
        <!--<div id=carta class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mt-4 card-tramite" data-tramite='horas_extras' data-img="giro_comercial.svg" data-url="horas_extras/solicitud">
            <a style="text-decoration: none; color: gray;" href="#!" data-toggle="modal" data-target="#modal-carta">
                <div style="height: 260px;" class="card card-hover-effect">
                    <div class="card-body d-flex flex-column justify-content-center align-items-center">
                        <div style="height: 110px" class="d-flex flex-column justify-content-center align-items-center">
                        ...
                        <div style="height: 150px" class="d-flex flex-column justify-content-center align-items-center">
                            <small class="text-center mt-3">Permisos extraordinarios para horas extras</small>
                            <div style="width: 50px; height: 50px; background-color: #ffc107; border-radius: 50%;" class="circle mt-4 d-flex justify-content-center align-items-center">
                                <i class="fas fa-arrow-right text-white"></i>
                            </div>
                        </div>
        ...
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mt-4 card-tramite">
            <a style="text-decoration: none; color: gray;" href="https://www.zapopan.gob.mx/req-pc-bomberos/">
                <div style="height: 260px;" class="card card-hover-effect">
                    <div class="card-body d-flex flex-column justify-content-center align-items-center">
                        <div style="height: 110px" class="d-flex flex-column justify-content-center align-items-center">
                            <img src="{{asset('media/ilustrator/giro_comercial.svg')}}" width="120px" alt="dirección de padrón y licencias" aria-hidden="true">
                            <span class="badge badge-warning mt-4">Tipos de riegos en giros</span>
                        </div>
                        <div style="height: 150px" class="d-flex flex-column justify-content-center align-items-center">
                            <small class="text-center mt-2">Reglamento y medidas a cumplir para protección civil y bomberos</small>
                            <div style="width: 50px; height: 50px; background-color: #ffc107; border-radius: 50%;" class="circle mt-4 d-flex justify-content-center align-items-center">
                                <i class="fas fa-arrow-right text-white"></i>
                            </div>
                        </div>
        ...
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mt-4 card-tramite">
            <a style="text-decoration: none; color: gray;" href="https://portal.zapopan.gob.mx/medioambiente/documentos/guiaprocedimientoverificacionambiental.pdf">
                <div style="height: 260px;" class="card card-hover-effect">
                    <div class="card-body d-flex flex-column justify-content-center align-items-center">
                        <div style="height: 110px" class="d-flex flex-column justify-content-center align-items-center">
                            <img src="{{asset('media/ilustrator/giro_comercial.svg')}}" width="120px" alt="dirección de padrón y licencias" aria-hidden="true">
                            <span class="badge badge-warning mt-2">Guía del procedimiento de verificación y <br> en materia ambiental</span>
                        </div>
                        <div style="height: 150px" class="d-flex flex-column justify-content-center align-items-center">
                            <small class="text-center mt-2">Requerimientos que se deben de cumplir en una revisión de Medio Ambiente</small>
                            <div style="width: 50px; height: 50px; background-color: #ffc107; border-radius: 50%;" class="circle mt-4 d-flex justify-content-center align-items-center">
                                <i class="fas fa-arrow-right text-white"></i>
                            </div>
                        </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title font bold">Términos y Condiciones <br> <small class="badge badge-warning f-11 label-tramites" style="transform: translateY(-2px);"></small></h5>
...
<div class="modal fade" id="modal-terminos" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-sm modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title font bold">AVISO DE PRIVACIDAD SIMPLIFICADO DEL GOBIERNO MUNICIPAL DE ZAPOPAN, JALISCO</h5>
            </div>
