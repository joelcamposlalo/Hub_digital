...
<div class="container position-relative" style="padding: 0 !important">
    <div class="d-flex align-items-center">
        ...
        <h1 class="text-muted font m-0 bold c-primary-color">Dirección de Medio Ambiente</h1>
    </div>
...
<div id="section">
    <div class="row">
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mt-4 card-tramite" data-tramite="Dictaminación de cantidades minimas de residuos solidos" data-img="ordenamiento.svg" data-url="dictamen_img_urbana/solicitud">
                ...
                <div style="height: 260px;" class="card card-hover-effect">
                    <div class="card-body d-flex flex-column justify-content-center align-items-center">
                        <div style="height: 110px" class="d-flex flex-column justify-content-center align-items-center">
                            ...
                            <span class="badge badge-warning mt-4" aria-hidden="true">Dirección de Medio Ambiente</span>
                        </div>
                        <div style="height: 150px" class="d-flex flex-column justify-content-center align-items-center">
                            <small class="text-center mt-2">Dictaminación de Generador de Cantidades Mínimas de Residuos Sólidos Urbanos.</small>
        ...
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mt-4 card-tramite" data-tramite="Dictamen de Materia de Impacto Ambiental para la Instalación de Biogestores" data-img="ordenamiento.svg" data-url="dictamen_img_urbana/solicitud">
            <a style="text-decoration: none; color: gray;" href="#!" data-toggle="modal" data-target="#modal-carta">
                <div style="height: 260px;" class="card card-hover-effect">
                    <div class="card-body d-flex flex-column justify-content-center align-items-center">
                        <div style="height: 110px" class="d-flex flex-column justify-content-center align-items-center">
                        ...
                        <div style="height: 150px" class="d-flex flex-column justify-content-center align-items-center">
                            <small class="text-center mt-2">Dictamen de Materia de Impacto Ambiental para la Instalación de Biogestores.</small>
                            <div style="width: 50px; height: 50px; background-color: #ffc107; border-radius: 50%;" class="circle mt-4 d-flex justify-content-center align-items-center">
                                <i class="fas fa-arrow-right text-white"></i>
                            </div>
                        </div>
        ...
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mt-4 card-tramite" data-tramite="Dictamen de Registro de Emisiones a la Atmósfera (REA)" data-img="ordenamiento.svg" data-url="dictamen_rea/solicitud">
            <a style="text-decoration: none; color: gray;" href="#!" data-toggle="modal" data-target="#modal-carta">
                <div style="height: 260px;" class="card card-hover-effect">
                    <div class="card-body d-flex flex-column justify-content-center align-items-center">
                        <div style="height: 110px" class="d-flex flex-column justify-content-center align-items-center">
                        ...
                        <div style="height: 150px" class="d-flex flex-column justify-content-center align-items-center">
                            <small class="text-center mt-2">Dictamen de Registro de Emisiones a la Atmósfera (REA).</small>
                            <div style="width: 50px; height: 50px; background-color: #ffc107; border-radius: 50%;" class="circle mt-4 d-flex justify-content-center align-items-center">
                                <i class="fas fa-arrow-right text-white"></i>
                            </div>
                        </div>
        ...
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mt-4 card-tramite" data-tramite="Registro al Padrón de Prestadores de Servicios en Materia de Evaluación Ambiental" data-img="ordenamiento.svg" data-url="dictamen_img_urbana/solicitud">
            <a style="text-decoration: none; color: gray;" href="#!" data-toggle="modal" data-target="#modal-carta">
                <div style="height: 260px;" class="card card-hover-effect">
                    <div class="card-body d-flex flex-column justify-content-center align-items-center">
                        <div style="height: 110px" class="d-flex flex-column justify-content-center align-items-center">
                        ...
                        <div style="height: 150px" class="d-flex flex-column justify-content-center align-items-center">
                            <small class="text-center mt-2">Registro al Padrón de Prestadores de Servicios en Materia de Evaluación Ambiental.</small>
                            <div style="width: 50px; height: 50px; background-color: #ffc107; border-radius: 50%;" class="circle mt-4 d-flex justify-content-center align-items-center">
                                <i class="fas fa-arrow-right text-white"></i>
                            </div>
                        </div>
        ...
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mt-4 card-tramite" data-tramite="Dictamen para Manejo de Arbolado" data-img="ordenamiento.svg" data-url="dictamen_img_urbana/solicitud">
            <a style="text-decoration: none; color: gray;" href="#!" data-toggle="modal" data-target="#modal-carta">
                <div style="height: 260px;" class="card card-hover-effect">
                    <div class="card-body d-flex flex-column justify-content-center align-items-center">
                        <div style="height: 110px" class="d-flex flex-column justify-content-center align-items-center">
                        ...
                        <div style="height: 150px" class="d-flex flex-column justify-content-center align-items-center">
                            <small class="text-center mt-2">Dictamen para Manejo de Arbolado.</small>
                            <div style="width: 50px; height: 50px; background-color: #ffc107; border-radius: 50%;" class="circle mt-4 d-flex justify-content-center align-items-center">
                                <i class="fas fa-arrow-right text-white"></i>
                            </div>
                        </div>
