...
<div class="container position-relative" style="padding: 0 !important">
    <div class="d-flex align-items-center">
        ...
        <h1 class="text-muted font m-0 bold c-primary-color">Dirección de Catastro</h1>
    </div>
    <small class="font text-muted mb-5">Trámites disponibles.</small>
</div>
...
<div id="section">
    <div class="row">
        ...
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mt-4">
            <a style="text-decoration: none; color: gray;" href="https://pagos.zapopan.gob.mx/PagoEnLinea/#/cobro-de-avaluos" target="_blank">
                <div style="height: 260px;" class="card card-hover-effect">
                    <div class="card-body d-flex flex-column justify-content-center align-items-center">
                        ...
                        <div style="height: 150px" class="d-flex flex-column justify-content-center align-items-center">
                            <small class="text-center mt-3">Cobro de derechos de avalúos</small>
        ...
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mt-4">
            <a style="text-decoration: none; color: gray;" href="https://pagos.zapopan.gob.mx/PagoEnLinea/#/busqueda-del-predio" target="_blank">
                <div style="height: 260px;" class="card card-hover-effect">
                    <div class="card-body d-flex flex-column justify-content-center align-items-center">
                        <div style="height: 110px" class="d-flex flex-column justify-content-center align-items-center">
                            <img src="{{asset('media/ilustrator/catastro.svg')}}" width="120px" alt="dirección de catastro" aria-hidden="true">
                        ...
                        <div style="height: 150px" class="d-flex flex-column justify-content-center align-items-center">
                            <small class="text-center mt-3">Constancia de no adeudo</small>
                            <div style="width: 50px; height: 50px; background-color: #ffc107; border-radius: 50%;" class="circle mt-4 d-flex justify-content-center align-items-center">
                                <i class="fas fa-arrow-right text-white"></i>
                            </div>
                        </div>
        ...
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mt-4">
            <a style="text-decoration: none; color: gray;" href="https://catastro.zapopan.gob.mx/portal_notarios/APP/login.php" target="_blank">
                <div style="height: 260px;" class="card card-hover-effect">
                    <div class="card-body d-flex flex-column justify-content-center align-items-center">
                        <div style="height: 110px" class="d-flex flex-column justify-content-center align-items-center">
                            <img src="{{asset('media/ilustrator/catastro.svg')}}" width="120px" alt="dirección de catastro" aria-hidden="true">
                        ...
                        <div style="height: 150px" class="d-flex flex-column justify-content-center align-items-center">
                            <small class="text-center mt-3">Portal de notarios</small>
                            <div style="width: 50px; height: 50px; background-color: #ffc107; border-radius: 50%;" class="circle mt-4 d-flex justify-content-center align-items-center">
                                <i class="fas fa-arrow-right text-white"></i>
                            </div>
                        </div>
        ...
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mt-4">
            <a style="text-decoration: none; color: gray;" href="https://catastro.zapopan.gob.mx/Consulta_Tramite/index.php" target="_blank">
                <div style="height: 260px;" class="card card-hover-effect">
                    <div class="card-body d-flex flex-column justify-content-center align-items-center">
                        <div style="height: 110px" class="d-flex flex-column justify-content-center align-items-center">
                            <img src="{{asset('media/ilustrator/catastro.svg')}}" width="120px" alt="dirección de catastro" aria-hidden="true">
                        ...
                        <div style="height: 150px" class="d-flex flex-column justify-content-center align-items-center">
                            <small class="text-center mt-3">Seguimiento de folio</small>
                            <div style="width: 50px; height: 50px; background-color: #ffc107; border-radius: 50%;" class="circle mt-4 d-flex justify-content-center align-items-center">
                                <i class="fas fa-arrow-right text-white"></i>
                            </div>
                        </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-sm modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body" style="height: 200px;">
                ...
                <br>
                <small>El presente aviso de privacidad puede ser modificado o actualizado con motivo de nuevos requerimientos legales o de las necesidades propias por los servicios que ofrecemos. Si desea conocer nuestro aviso de privacidad integral lo podrá consultar a través de la página de internet de este sujeto obligado, la cual es: <a href="https://www.zapopan.gob.mx/"> www.zapopan.gob.mx</a> o bien de manera presencial en nuestras instalaciones.</small>
