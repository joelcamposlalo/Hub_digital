        ...
        <div class="row">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mt-4">
                <a style="text-decoration: none; color: gray;"
                    href="https://pagos.zapopan.gob.mx/PagoEnLinea/#/cobro-de-avaluos" target="_blank">
                    <div style="height: 260px;" class="card card-hover-effect">
                        <div class="card-body d-flex flex-column justify-content-center align-items-center">
                            <div style="height: 110px" class="d-flex flex-column justify-content-center align-items-center">
                                <img src="{{ asset('media/ilustrator/catastro.svg') }}" width="120px"
                                    alt="dirección de catastro" aria-hidden="true">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mt-4">
                <a style="text-decoration: none; color: gray;"
                    href="https://pagos.zapopan.gob.mx/PagoEnLinea/#/busqueda-del-predio" target="_blank">
                    <div style="height: 260px;" class="card card-hover-effect">
                        <div class="card-body d-flex flex-column justify-content-center align-items-center">
                            <div style="height: 110px" class="d-flex flex-column justify-content-center align-items-center">
                                <img src="{{ asset('media/ilustrator/catastro.svg') }}" width="120px"
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mt-4">
                <a style="text-decoration: none; color: gray;"
                    href="https://catastro.zapopan.gob.mx/portal_notarios/APP/login.php" target="_blank">
                    <div style="height: 260px;" class="card card-hover-effect">
                        <div class="card-body d-flex flex-column justify-content-center align-items-center">
                            <div style="height: 110px" class="d-flex flex-column justify-content-center align-items-center">
                                <img src="{{ asset('media/ilustrator/catastro.svg') }}" width="120px"
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mt-4">
                <a style="text-decoration: none; color: gray;"
                    href="https://catastro.zapopan.gob.mx/Consulta_Tramite/index.php" target="_blank">
                    <div style="height: 260px;" class="card card-hover-effect">
                        <div class="card-body d-flex flex-column justify-content-center align-items-center">
                            <div style="height: 110px" class="d-flex flex-column justify-content-center align-items-center">
                                <img src="{{ asset('media/ilustrator/catastro.svg') }}" width="120px"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" style="height: 200px;">
                    ...
                    <small>El presente aviso de privacidad puede ser modificado o actualizado con motivo de nuevos
                        ...
                        este sujeto obligado, la cual es: <a href="https://www.zapopan.gob.mx/"> www.zapopan.gob.mx</a> o
                        bien de manera presencial en nuestras instalaciones.</small>
