...
<div class="container position-relative" style="padding: 0 !important">
    <div class="d-flex align-items-center">
        ...
        <h1 class="text-muted font m-0 bold c-primary-color">Expediente Único Municipal</h1>
    </div>
    <small class="font text-muted mb-5 f-15">Todos tus documentos en un solo lugar</small>
...
<div id="section">
    <div class="row">
        ...
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mt-4 card-tramite" data-tramite="Expediente Único Municipal" data-img="EUM.png" data-url="expediente_unico_municipal/solicitud">
                ...
                <div style="height: 260px;" class="card card-hover-effect">
                    <div class="card-body d-flex flex-column justify-content-center align-items-center">
                        <div style="height: 110px" class="d-flex flex-column justify-content-center align-items-center">
                            ...
                            <span class="badge badge-warning mt-4" aria-hidden="true">Nuevo Expediente</span>
                        </div>
                        <div style="height: 150px" class="d-flex flex-column justify-content-center align-items-center">
                            <small class="text-center mt-2">Consulta los documentos</small>
