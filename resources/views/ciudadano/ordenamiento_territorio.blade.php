...
@section('title', 'Ordenamiento del Territorio')
...
<div class="container position-relative" style="padding: 0 !important">
    <div class="d-flex align-items-center">
        ...
        <h1 class="text-muted font m-0 bold c-primary-color">Dirección de Ordenamiento del Territorio</h1>
    </div>
    ...
    @if(!empty($leyendaVac[0]) && ($leyendaVac[0]->fecha_inicio < $hoy) && ($leyendaVac[0]->fecha_fin > $hoy))
        ...
        <div class="alert alert-warning alert-dismissible fade show notas mt-2" role="alert">
            <strong class="f-15">Nota:</strong> <small class="f-15"> {{$hoy}} @if(!empty($leyendaVac[0])) {!! $leyendaVac[0]->nota !!} @endif<nav></nav></small>
        </div>
    @endif
    @if(!empty($leyendaVacDIU[0]) && ($leyendaVacDIU[0]->fecha_inicio < $hoy) && ($leyendaVacDIU[0]->fecha_fin > $hoy))

        <div class="alert alert-warning alert-dismissible fade show notas mt-2" role="alert">
            <strong class="f-15">Nota trámite Dictamen de Imagen Urbana:</strong> <small class="f-15"> @if(!empty($leyendaVacDIU[0])) {!! $leyendaVacDIU[0]->nota !!} @endif<nav></nav></small>
        </div>
    @endif
</div>
...
<div id="section">
    <div class="row">
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mt-4 card-tramite" data-tramite="Dicatamen de Imagen Urbana" data-img="ordenamiento.svg" data-url="dictamen_img_urbana/solicitud">
                ...
                <div style="height: 260px;" class="card card-hover-effect">
                    <div class="card-body d-flex flex-column justify-content-center align-items-center">
                        <div style="height: 110px" class="d-flex flex-column justify-content-center align-items-center">
                            <img src="{{asset('media/ilustrator/img_formatos.png')}}" width="120px" alt="Dirección de Ordenamiento del Territorio" aria-hidden="true">
                            <span class="badge badge-warning mt-4" aria-hidden="true">Dirección de Ordenamiento del Territorio</span>
                        </div>
                        <div style="height: 150px" class="d-flex flex-column justify-content-center align-items-center">
                            <small class="text-center mt-2">Dictamen de Imagen Urbana</small>
        ...
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mt-4 card-tramite" data-tramite="Dictamen de Finca Antigua" data-img="ordenamiento.svg" data-url="dictamen_finca_antigua/solicitud">
       
<a style="text-decoration: none; color: gray;" href="#!" data-toggle="modal" data-target="#modal-carta">
                <div style="height: 260px;" class="card card-hover-effect">
                    <div class="card-body d-flex flex-column justify-content-center align-items-center">
                        <div style="height: 110px" class="d-flex flex-column justify-content-center align-items-center">
                            <img src="{{asset('media/ilustrator/img_plano.png')}}" width="120px" alt="Dirección de Ordenamiento del Territorio" aria-hidden="true">
                            <span class="badge badge-warning mt-4" aria-hidden="true">Dirección de Ordenamiento del Territorio</span>
                        </div>
                        <div style="height: 150px" class="d-flex flex-column justify-content-center align-items-center">
                            <small class="text-center mt-2">Dictamen de Finca Antigua</small>
                            <div style="width: 50px; height: 50px; background-color: #ffc107; border-radius: 50%;" class="circle mt-4 d-flex justify-content-center align-items-center">
                                <i class="fas fa-arrow-right text-white"></i>
                            </div>
                        </div>
        ...
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mt-4 card-tramite" data-tramite="Dictamen de Trazo, Usos y Destinos Específicos" data-img="ordenamiento.svg" data-url="dictamen_trazos_usos/solicitud">
            <a style="text-decoration: none; color: gray;" href="#!" data-toggle="modal" data-target="#modal-carta">
                <div style="height: 260px;" class="card card-hover-effect">
                    <div class="card-body d-flex flex-column justify-content-center align-items-center">
                        <div style="height: 110px" class="d-flex flex-column justify-content-center align-items-center">
                            <img src="{{asset('media/ilustrator/img_directores.png')}}" width="120px" alt="Dirección de Ordenamiento del Territorio" aria-hidden="true">
                            <span class="badge badge-warning mt-4" aria-hidden="true">Dirección de Ordenamiento del Territorio</span>
                        </div>
                        <div style="height: 150px" class="d-flex flex-column justify-content-center align-items-center">
                            <small class="text-center mt-2">Dictamen de Trazo, Usos y Destinos Específicos</small>
                            <div style="width: 50px; height: 50px; background-color: #ffc107; border-radius: 50%;" class="circle mt-4 d-flex justify-content-center align-items-center">
                                <i class="fas fa-arrow-right text-white"></i>
                            </div>
                        </div>
 ...
 <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mt-4 card-tramite" data-tramite="Revisión de Proyecto en Línea de Ordenamiento del Territorio" data-img="ordenamiento.svg" data-url="revision_proyectoot/solicitud">
            <a style="text-decoration: none; color: gray;" href="#!" data-toggle="modal" data-target="#modal-carta">
                <div style="height: 260px;" class="card card-hover-effect">
                    <div class="card-body d-flex flex-column justify-content-center align-items-center">
                        <div style="height: 110px" class="d-flex flex-column justify-content-center align-items-center">
                            <img src="{{asset('media/ilustrator/img_revision.png')}}" width="120px" alt="Dirección de Ordenamiento del Territorio" aria-hidden="true">
                            <span class="badge badge-warning mt-4" aria-hidden="true">Dirección de Ordenamiento del Territorio</span>
                        </div>
                        <div style="height: 150px" class="d-flex flex-column justify-content-center align-items-center">
                            <small class="text-center mt-2">Revisión de Proyecto en Línea de Ordenamiento del Territorio</small>
                            <div style="width: 50px; height: 50px; background-color: #ffc107; border-radius: 50%;" class="circle mt-4 d-flex justify-content-center align-items-center">
                                <i class="fas fa-arrow-right text-white"></i>
                            </div>
                        </div>
