...
@section('container')
<h1 class="text-muted font m-0 bold c-primary-color">Certificado de habitabilidad @isset($id_captura)@endisset</h1>
    ...
    <div class="col-md-9">
        <div class="etapas d-flex justify-content-center align-items-center">
            <div style="width: 60px;" class="d-flex flex-column justify-content-center align-items-center">
                <div class="etapa border @if($id_etapa == 73) process @else active @endif d-flex justify-content-center align-items-center">
                    @if($id_etapa != 73)
                    ...
                    @endif
                    <small class="font f-15 bold @if($id_etapa != 73) text-white @else text-muted @endif">1</small>
                </div>
                <small class="mt-1 mb-1 font c-carbon f-10">Solicitud</small>
            </div>
            <div class="@if($id_etapa != 73) line @else line_off @endif"></div>
            <div style="width: 60px; transform: translateY(7px);" class="d-flex flex-column justify-content-center align-items-center">
                <div class="etapa  @if($id_etapa == 77 ) active text-white @elseif($id_etapa == 74 || $id_etapa == 75 || $id_etapa == 77) process @endif  border d-flex justify-content-center align-items-center">
                    @if($id_etapa == 77)
                    <div class="success d-flex justify-content-center align-items-center">
                        <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-check2 bold text-white" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" d="M13.854 3.646a.5.5 0 0 1 0 .708l-7 7a.5.5 0 0 1-.708 0l-3.5-3.5a.5.5 0 1 1 .708-.708L6.5 10.293l6.646-6.647a.5.5 0 0 1 .708 0z" />
                    ...
                    @endif
                    <small class="font f-15 bold @if($id_etapa == 77 ) text-white @else text-muted @endif ">2</small>
                </div>
                <small class="mt-1 mb-1 font c-carbon f-10 text-center">Adjuntar requisitos</small>
            </div>
            <div class="@if($id_etapa == 77) line @else line_off @endif"></div>
            <div style="width: 60px; transform: translateY(7px);" class="d-flex flex-column justify-content-center align-items-center">
                <div class="etapa  @if($id_etapa == 77) active @else process @endif border d-flex justify-content-center align-items-center">
                    @if($id_etapa == 77)
                    <div class="success d-flex justify-content-center align-items-center">
                        <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-check2 bold text-white" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" d="M13.854 3.646a.5.5 0 0 1 0 .708l-7 7a.5.5 0 0 1-.708 0l-3.5-3.5a.5.5 0 1 1 .708-.708L6.5 10.293l6.646-6.647a.5.5 0 0 1 .708 0z" />
                    ...
                    @endif
                    <small class="font f-15 bold @if($id_etapa == 77) text-white @else text-muted @endif">3</small>
                </div>
                <small class="mt-1 mb-1 font c-carbon f-10 text-center">Carta responsiva</small>
            </div>
            <div class="@if($id_etapa == 77) line @else line_off @endif"></div>
            <div style="width: 60px;" class="d-flex flex-column justify-content-center align-items-center">
                <div class="etapa  @if($id_etapa == 77) active @endif border d-flex justify-content-center align-items-center">
                    @if($id_etapa == 77)
                    <div class="success d-flex justify-content-center align-items-center">
                        <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-check2 bold text-white" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" d="M13.854 3.646a.5.5 0 0 1 0 .708l-7 7a.5.5 0 0 1-.708 0l-3.5-3.5a.5.5 0 1 1 .708-.708L6.5 10.293l6.646-6.647a.5.5 0 0 1 .708 0z" />
                    ...
                    @endif
                    <small class="font f-15 bold @if($id_etapa == 77) text-white @else text-muted @endif">4</small>
                </div>
    ...
    <div class="col-md-9 mt-4" id="top-4">
        <div class="card  shadow-sm card_4 rounded border-none">
            ...
            <div class="card-body">
                ...
                <form id="form_4" action="{{url('certificado_habitabilidad/ingresa_tramite')}}" method="POST" enctype="multipart/form-data">
                    @csrf
...
<script>
    ...
    $(document).ready(function() {
        ...
        @if(isset($id_etapa) && ($id_etapa == 77)) //completado
        $('.continuar').fadeOut();
        $('.btn-guardar').fadeOut();
        $('.btn-form3').fadeOut();
        $('.btn-buscar').fadeOut();
        ...
        @if(isset($id_etapa) && ($id_etapa == 78))  //regresado al ciudadano
        $('.descarga').fadeOut();
        ...
        @if(isset($id_etapa) && ($id_etapa == 74)) //datos de la solicitud
        $('.card_1 .card-body').slideUp('slow');
        $('.card_3 .card-body').slideDown('slow');
        $('.continuar').fadeIn();
        @elseif(isset($id_etapa) && ($id_etapa == 75)) //archivos de la solicitud
        $('.card_1 .card-body').slideUp('slow');
        $('.card_4 .card-body').slideDown('slow');
        $('.continuar').fadeIn();
        @endif
        ...
        $('#form_3').submit(async function(e) {
            ...
            if (id_solicitud > 0) {
                ...
                if ($('#id_captura').val() == "") {
                    ...
                    var res = await axios.post('{{url("certificado_habitabilidad/ingresa_solitud")}}',
                        formdata, {
                            data: {
                                "_token": "{{ csrf_token() }}"
                            }
                    ...
                    var res = await axios.post('{{url("certificado_habitabilidad/actualiza_solitud")}}',
                        formdata, {
                            data: {
                                "_token": "{{ csrf_token() }}"
                            }
    ...
    function consulta_licencia(licencia) {
        ...
        limpia_form();
        $.ajax({
            url: "{{url('certificado_habitabilidad/get_by_licencia')}}",
            data: {
                "_token": "{{ csrf_token() }}",
                "clave": licencia
            },
