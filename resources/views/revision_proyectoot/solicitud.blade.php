...
<h1 class="text-muted font m-0 bold c-primary-color">Revisión del Proyecto en Línea @isset($id_captura)@endisset</h1>
    ...
    <div class="col-md-9">
        <div class="etapas d-flex justify-content-center align-items-center">
            <div style="width: 60px;" class="d-flex flex-column justify-content-center align-items-center">
                <div class="etapa border @if($id_etapa == 33) process @else active @endif d-flex justify-content-center align-items-center">
                    @if($id_etapa != 33)
                    ...
                    @endif
                    <small class="font f-15 bold @if($id_etapa != 33) text-white @else text-muted @endif">1</small>
                </div>
                <small class="mt-1 mb-1 font c-carbon f-10">Solicitud</small>
            </div>
            <div class="@if($id_etapa != 33) line @else line_off @endif"></div>
            <div style="width: 60px; transform: translateY(7px);" class="d-flex flex-column justify-content-center align-items-center">
                <div class="etapa  @if($id_etapa == 37 || $id_etapa == 39) active text-white @elseif($id_etapa == 34 || $id_etapa == 35 || $id_etapa == 38) process @endif  border d-flex justify-content-center align-items-center">
                    @if($id_etapa == 37 || $id_etapa == 39)
                    <div class="success d-flex justify-content-center align-items-center">
                        <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-check2 bold text-white" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" d="M13.854 3.646a.5.5 0 0 1 0 .708l-7 7a.5.5 0 0 1-.708 0l-3.5-3.5a.5.5 0 1 1 .708-.708L6.5 10.293l6.646-6.647a.5.5 0 0 1 .708 0z" />
                        </svg>
                    ...
                    @endif
                    <small class="font f-15 bold @if($id_etapa == 37 || $id_etapa == 39) text-white @else text-muted @endif ">2</small>
                </div>
                <small class="mt-1 mb-1 font c-carbon f-10 text-center">Adjuntar requisitos</small>
            </div>
            <div class="@if($id_etapa == 37 || $id_etapa == 39) line @else line_off @endif"></div>
            <div style="width: 60px; transform: translateY(7px);" class="d-flex flex-column justify-content-center align-items-center">
                <div class="etapa  @if($id_etapa == 37) active @elseif($id_etapa == 39) process @endif border d-flex justify-content-center align-items-center">
                    @if($id_etapa == 37)
                    <div class="success d-flex justify-content-center align-items-center">
                        <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-check2 bold text-white" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" d="M13.854 3.646a.5.5 0 0 1 0 .708l-7 7a.5.5 0 0 1-.708 0l-3.5-3.5a.5.5 0 1 1 .708-.708L6.5 10.293l6.646-6.647a.5.5 0 0 1 .708 0z" />
                    ...
                    @endif
                    <small class="font f-15 bold @if($id_etapa == 37) text-white @else text-muted @endif">3</small>
                </div>
                <small class="mt-1 mb-1 font c-carbon f-10 text-center">Carta responsiva</small>
            </div>
            <div class="@if($id_etapa == 37) line @else line_off @endif"></div>
            <div style="width: 60px;" class="d-flex flex-column justify-content-center align-items-center">
                <div class="etapa  @if($id_etapa == 37) active @endif border d-flex justify-content-center align-items-center">
                    @if($id_etapa == 37)
                    <div class="success d-flex justify-content-center align-items-center">
                        <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-check2 bold text-white" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" d="M13.854 3.646a.5.5 0 0 1 0 .708l-7 7a.5.5 0 0 1-.708 0l-3.5-3.5a.5.5 0 1 1 .708-.708L6.5 10.293l6.646-6.647a.5.5 0 0 1 .708 0z" />
                    ...
                    @endif
                    <small class="font f-15 bold @if($id_etapa == 37) text-white @else text-muted @endif">4</small>
                </div>
                ...
                <form id=form_2 method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mt-2">
                            ...
                            <input name="letraE" id="letraE" value="{{((isset($letraE))?$letraE:'')}}" class="ab-form background-color rounded border letraE" type="text">
                        </div>
                        <div class="col-md-3 mt-2">
                        ...
                        <div class="col-md-3 mt-2">
                            ...
                            <input name="letraI" id="letraI" value="{{((isset($LetraI))?$LetraI:'')}}" class="ab-form background-color rounded border capitalize LetraI" type="text">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mt-2">
                    ...
                    <div class="row">
                        ...
                        <!--<div class="col-md-6 mt-2">
                            ...
                            <input name="privativa" value="{{((isset($privativa))?$privativa:'')}}" class="ab-form background-color rounded border capitalize privativa" type="text">
                        </div>-->
                    </div>
                    <div class="row">
                        <div class="col-md-6 mt-2">
                    ...
                    <div class="row">
                        <div class="col-md-6 mt-2">
                            ...
                            <select name="giro" id="giro" class="ab-form background-color rounded border giro" required onchange="if(this.value==2) { $('#casas_habitacion').attr('disabled',false); $('#casas_habitacion').attr('required',true);}
                            else{ $('#casas_habitacion').attr('disabled',true); $('#casas_habitacion').attr('required',false);}">
                    ...
                    <div class="row">
                        <div class="col-md-6 mt-2">
                            <label for="casas_habitacion"><small>Casas habitación:</small></label>
                            <select name="casas_habitacion" id="casas_habitacion" class="ab-form background-color rounded border casas_habitacion" required @if (!isset($giro)||$giro!="2" ) disabled @endif>
                                <option value="">Seleccione el número de casas</option>
                                @if (isset($casas_habitacion)&&$casas_habitacion==1)
                                <option value="1" selected="selected">1</option>
                                @else
                                <option value="1">1</option>
                                @endif
                                @if (isset($casas_habitacion)&&$casas_habitacion==2)
                                <option value="2" selected="selected">2 o más</option>
                                @else
                ...
                <form id=form_3 method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mt-2">
                            ...
                            <input name="telefono" id="telefono" class="ab-form background-color rounded border telefono" type="text" value="{{((isset($telefono))?$telefono:session('telefono'))}}" data-parsley-type="number" data-parsley-minlength="10" maxlength="10" require>
        ...
        <div class="card  shadow-sm card_4 rounded border-none">
            ...
            <div class="card-body">
                <div class="alert alert-warning alert-dismissible fade show mt-4" role="alert">
                    ...
                    <h5 class="font">
                        Debes adjuntar todos los archivos obligatorios.
                    </h5>

                </div>
                <form id="form_4" action="{{url('revision_proyectoot/ingresa_tramite')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="responsive w-100" style="width: 100%; overflow-x: auto;">
                        <table class="w-100">
...
<script>
    ...
    $(document).ready(function() {
        ...
        @if(isset($id_etapa) && ($id_etapa == 94))
        $('.card_1 .card-body').slideUp('slow');
        $('.card_3 .card-body').slideDown('slow');
        $('.continuar').fadeIn();
        @elseif(isset($id_etapa) && ($id_etapa == 95))
        $('.card_1 .card-body').slideUp('slow');
        $('.card_2 .card-body').slideUp('slow');
        $('.card_3 .card-body').slideDown('slow');
        ...
        $('#form_3').submit(async function(e) {
            ...
            var casas_habitacion = $('.casas_habitacion').val();
            ...
            if (id_solicitud > 0) {
                ...
                formdata.append('casas_habitacion', casas_habitacion);
                ...
                if ($('#id_captura').val() == "") {
                    ...
                    var res = await axios.post('{{url("revision_proyectoot/ingresa_solitud")}}', formdata, {
                        data: {
                            "_token": "{{ csrf_token() }}"
                        }
                    ...
                    var res = await axios.post('{{url("revision_proyectoot/actualiza_solitud")}}', formdata, {
                        data: {
                            "_token": "{{ csrf_token() }}"
                        }
                    }).then(function(response) {
        ...
        */
        ...
        $('.aqui').click(function() {
            ...
            var url = '{{url("trabajos_menores/carta")}}'
