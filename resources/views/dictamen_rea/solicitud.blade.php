...
@section('container')
<h1 class="text-muted font m-0 bold c-primary-color">Dictamen de Registro de Emisiones a la Atmósfera @isset($id_captura)@endisset</h1>
    ...
    <div class="col-md-9">
        <div class="etapas d-flex justify-content-center align-items-center">
            <div style="width: 60px;" class="d-flex flex-column justify-content-center align-items-center">
                <div class="etapa border @if($id_etapa == 106) process @else active @endif d-flex justify-content-center align-items-center">
                    @if($id_etapa != 106 && $id_etapa != 111)
                    ...
                    @endif
                    <small class="font f-15 bold @if($id_etapa != 106) @else text-muted @endif">1</small>
                </div>
                <small class="mt-1 mb-1 font c-carbon f-10">Solicitud</small>
            </div>
            <div class="@if($id_etapa != 106) line @else line_off @endif"></div>
            <div style="width: 60px; transform: translateY(7px);" class="d-flex flex-column justify-content-center align-items-center">
                <div class="etapa  @if($id_etapa == 108 || $id_etapa == 112) active text-white @elseif($id_etapa == 107 || $id_etapa == 108 || $id_etapa == 111) process @endif  border d-flex justify-content-center align-items-center">
                    ...
                    @endif
                    <small class="font f-15 bold @if($id_etapa == 108 || $id_etapa == 112) text-white @else text-muted @endif ">2</small>
                </div>
                <small class="mt-1 mb-1 font c-carbon f-10 text-center">Adjuntar requisitos</small>
            </div>
            <div class="@if($id_etapa == 110 || $id_etapa == 112) line @else line_off @endif"></div>
            <div style="width: 60px; transform: translateY(7px);" class="d-flex flex-column justify-content-center align-items-center">
                <div class="etapa  @if($id_etapa == 110) active @elseif($id_etapa == 18) process @endif border d-flex justify-content-center align-items-center">
                    @if($id_etapa == 110)
                    <div class="success d-flex justify-content-center align-items-center">
                        <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-check2 bold text-white" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" d="M13.854 3.646a.5.5 0 0 1 0 .708l-7 7a.5.5 0 0 1-.708 0l-3.5-3.5a.5.5 0 1 1 .708-.708L6.5 10.293l6.646-6.647a.5.5 0 0 1 .708 0z" />
                    ...
                    @endif
                    <small class="font f-15 bold @if($id_etapa == 110) text-white @else text-muted @endif">3</small>
                </div>
                <small class="mt-1 mb-1 font c-carbon f-10 text-center">Carta responsiva</small>
            </div>
            <div class="@if($id_etapa == 110) line @else line_off @endif"></div>
            <div style="width: 60px;" class="d-flex flex-column justify-content-center align-items-center">
                <div class="etapa  @if($id_etapa == 110) active @endif border d-flex justify-content-center align-items-center">
                    @if($id_etapa == 110)
                    <div class="success d-flex justify-content-center align-items-center">
                        <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-check2 bold text-white" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" d="M13.854 3.646a.5.5 0 0 1 0 .708l-7 7a.5.5 0 0 1-.708 0l-3.5-3.5a.5.5 0 1 1 .708-.708L6.5 10.293l6.646-6.647a.5.5 0 0 1 .708 0z" />
                    ...
                    @endif
                    <small class="font f-15 bold @if($id_etapa == 110) text-white @else text-muted @endif">4</small>
                </div>
            ...
            <div class="card-body">
                <div class="alert alert-warning alert-dismissible fade show mt-4 notas" role="alert">
                    ...
                    <h6 class="font">
                        ...
                        <a href="{{url('dictamen_rea/descargarPlano')}}" target="_blank">aquí</a>
                    </h6>
                </div>
                <form id="form_4" action="{{url('dictamen_rea/ingresa_tramite')}}" method="POST" enctype="multipart/form-data">
                    @csrf
...
<script>
    ...
    $(document).ready(function() {
        ...
        @if(isset($id_etapa) && $id_etapa == 106)
        ...
        @if(isset($id_etapa) && $id_etapa == 107)
        ...
        @if(isset($id_etapa) && $id_etapa == 108)
        $('.card_1 .card-body').slideUp('fast');
        $('.card_2 .card-body').slideUp('fast');
        $('.card_3 .card-body').slideUp('fast');
        ...
        @if(isset($id_etapa) && $id_etapa == 109)
        ...
        @if(isset($id_etapa) && $id_etapa == 110)
        ...
        @if(isset($id_etapa) && $id_etapa == 111)
        $('.card_1 .card-body').slideUp('fast');
        $('.card_2 .card-body').slideUp('fast');
        $('.card_3 .card-body').slideDown('slow');
        $('.card_4 .card-body').slideUp('fast');
        ...
        @if(isset($id_etapa) && $id_etapa == 112)
        $('.continuar').fadeOut();
        $('.btn-guardar').fadeOut();
        $('.btn-form3').fadeOut();
        $('.btn-buscar').fadeOut();
        ...
        $('#form_3').submit(async function(e) {
            ...
            if (id_solicitud > 0) {
                ...
                if ($('#id_captura').val() == "") {
                    ...
                    var res = await axios.post('{{url("dictamen_rea/ingresa_solicitud")}}',
                        formdata, {
                            data: {
                                "_token": "{{ csrf_token() }}"
                            }
                    ...
                    var res = await axios.post('{{url("dictamen_rea/actualiza_solicitud")}}',
                        formdata, {
                            data: {
                                "_token": "{{ csrf_token() }}"
                            }
        ...
        */
        ...
        $('.aqui').click(function() {
            ...
            var url = '{{url("dictamen_rea/carta")}}'
