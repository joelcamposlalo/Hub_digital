    ...
    <div class="col-md-9">
        <div class="etapas d-flex justify-content-center align-items-center">
            <div style="width: 60px;" class="d-flex flex-column justify-content-center align-items-center">
                <div class="etapa border @if($id_etapa == 33) active @else process @endif d-flex justify-content-center align-items-center">
                    @if($id_etapa == 33)
            ...
            <div style="width: 60px; transform: translateY(7px);" class="d-flex flex-column justify-content-center align-items-center">
                <div class="etapa  @if($id_etapa == 34 or $id_etapa == 35 or $id_etapa == 37) active text-white @else process @endif  border d-flex justify-content-center align-items-center">
                    @if($id_etapa == 34 or $id_etapa == 35 or $id_etapa == 37)
                    <div class="success d-flex justify-content-center align-items-center">
                        <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-check2 bold text-white" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" d="M13.854 3.646a.5.5 0 0 1 0 .708l-7 7a.5.5 0 0 1-.708 0l-3.5-3.5a.5.5 0 1 1 .708-.708L6.5 10.293l6.646-6.647a.5.5 0 0 1 .708 0z" />
                        </svg>
                    ...
                    @endif
                    <small class="font f-15 bold @if($id_etapa == 34 or $id_etapa == 35 or $id_etapa == 37) text-white @else text-muted @endif ">2</small>
                </div>
                <small class="mt-1 mb-1 font c-carbon f-10 text-center">Adjuntar requisitos</small>
            </div>
            <div class="line"></div>
            <div style="width: 60px; transform: translateY(7px);" class="d-flex flex-column justify-content-center align-items-center">
                <div class="etapa  @if($id_etapa == 39) active @else process @endif border d-flex justify-content-center align-items-center">
                    @if($id_etapa == 39)
                    <div class="success d-flex justify-content-center align-items-center">
                        <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-check2 bold text-white" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" d="M13.854 3.646a.5.5 0 0 1 0 .708l-7 7a.5.5 0 0 1-.708 0l-3.5-3.5a.5.5 0 1 1 .708-.708L6.5 10.293l6.646-6.647a.5.5 0 0 1 .708 0z" />
                    ...
                    @endif
                    <small class="font f-15 bold @if($id_etapa == 39) text-white @else text-muted @endif">3</small>
                </div>
            ...
            <div style="width: 60px;" class="d-flex flex-column justify-content-center align-items-center">
                <div class="etapa  @if($id_etapa == 39) active @else process @endif border d-flex justify-content-center align-items-center">
                    ...
                    @endif
                    <small class="font f-15 bold @if($id_etapa == 39) text-white @else text-muted @endif">4</small>
                </div>
                ...
                <form id=form_3 method="post">
                    ...
                    <div class="row mt-4">
                        <div class="col-md-12 mt-2 text-right">
                            ...
                            <input class="ab-btn b-primary-color btn-predial btn-guardar" type="submit" value="Continuar">
                        </div>
                    </div>
                </form>
            </div>
    ...
    <div class="col-md-9 mt-4" id="top-4">
        <div class="card  shadow-sm card_4 rounded border-none">
            ...
            <div class="card-body">
                ...
                <form id="form_4" action="{{url('revision_proyecto/ingresa_tramite')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="responsive w-100" style="width: 100%; overflow-x: auto;">
                        <table class="w-100">
...
<script>
    ...
    $(document).ready(function() {
        ...
        @if(isset($id_etapa) && ($id_etapa == 34))
        $('.card_1 .card-body').slideUp('slow');
        $('.card_3 .card-body').slideDown('slow');
        $('.continuar').fadeIn();
        @elseif(isset($id_etapa) && ($id_etapa == 35))
        $('.card_1 .card-body').slideUp('slow');
        $('.card_2 .card-body').slideDown('slow');
        $('.card_3 .card-body').slideDown('slow');
        $('.card_4 .card-body').slideDown('slow');
        ...
        $('#form_3').submit(async function(e) {
            ...
            if (id_solicitud > 0) {
                ...
                if ($('#id_captura').val() == "") {
                    ...
                    var res = await axios.post('{{url("revision_proyecto/ingresa_solitud")}}', formdata, {
                        data: {
                            "_token": "{{ csrf_token() }}"
                        }
                    ...
                    var res = await axios.post('{{url("revision_proyecto/actualiza_solitud")}}', formdata, {
                        data: {
                            "_token": "{{ csrf_token() }}"
                        }
                    }).then(function(response) {
