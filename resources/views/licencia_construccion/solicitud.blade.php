...
@section('container')
<h1 class="text-muted font m-0 bold c-primary-color">Licencia de Contrucción @isset($id_captura) @endisset</h1>
    ...
    <div class="col-md-9">
        <div class="etapas d-flex justify-content-center align-items-center">
            <div style="width: 60px;" class="d-flex flex-column justify-content-center align-items-center">
                <div class="etapa border @if($id_etapa == 19) active @else process @endif d-flex justify-content-center align-items-center">
                    @if($id_etapa == 19)
                    ...
                    @endif
                    <small class="font f-15 bold @if($id_etapa == 19) text-white @else text-muted @endif">1</small>
                </div>
            ...
            <div style="width: 60px; transform: translateY(7px);" class="d-flex flex-column justify-content-center align-items-center">
                <div class="etapa  @if($id_etapa == 20 or $id_etapa == 21 or $id_etapa == 24) active text-white @else process @endif  border d-flex justify-content-center align-items-center">
                    @if($id_etapa == 20 or $id_etapa == 21 or $id_etapa == 24)
                    <div class="success d-flex justify-content-center align-items-center">
                        <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-check2 bold text-white" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" d="M13.854 3.646a.5.5 0 0 1 0 .708l-7 7a.5.5 0 0 1-.708 0l-3.5-3.5a.5.5 0 1 1 .708-.708L6.5 10.293l6.646-6.647a.5.5 0 0 1 .708 0z" />
                        </svg>
                    ...
                    @endif
                    <small class="font f-15 bold @if($id_etapa == 20 or $id_etapa == 21 or $id_etapa == 24) text-white @else text-muted @endif ">2</small>
                </div>
                <small class="mt-1 mb-1 font c-carbon f-10 text-center">Adjuntar requisitos</small>
            </div>
            <div class="line"></div>
            <div style="width: 60px; transform: translateY(7px);" class="d-flex flex-column justify-content-center align-items-center">
                <div class="etapa  @if($id_etapa == 25) active @else process @endif border d-flex justify-content-center align-items-center">
                    @if($id_etapa == 25)
                    <div class="success d-flex justify-content-center align-items-center">
                        <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-check2 bold text-white" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" d="M13.854 3.646a.5.5 0 0 1 0 .708l-7 7a.5.5 0 0 1-.708 0l-3.5-3.5a.5.5 0 1 1 .708-.708L6.5 10.293l6.646-6.647a.5.5 0 0 1 .708 0z" />
                    ...
                    @endif
                    <small class="font f-15 bold @if($id_etapa == 25) text-white @else text-muted @endif">3</small>
                </div>
                <small class="mt-1 mb-1 font c-carbon f-10 text-center">Carta responsiva</small>
            </div>
            <div class="line"></div>
            <div style="width: 60px;" class="d-flex flex-column justify-content-center align-items-center">
                <div class="etapa  @if($id_etapa == 23) active @else process @endif border d-flex justify-content-center align-items-center">
                    @if($id_etapa == 23)
                    <div class="success d-flex justify-content-center align-items-center">
                        <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-check2 bold text-white" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" d="M13.854 3.646a.5.5 0 0 1 0 .708l-7 7a.5.5 0 0 1-.708 0l-3.5-3.5a.5.5 0 1 1 .708-.708L6.5 10.293l6.646-6.647a.5.5 0 0 1 .708 0z" />
                    ...
                    @endif
                    <small class="font f-15 bold @if($id_etapa == 23) text-white @else text-muted @endif">4</small>
                </div>
...
<div class="row position-relative">
    ...
    <div class="col-md-3 mt-4 position-absolute" style="right: 0;">
        ...
        <div class="alert alert-warning alert-dismissible fade show mt-3 linkPago ocultar" role="alert">
                ...
                <form id=form_2 method="post">
                    ...
                    <div class="row">
                        <div class="col-md-6 mt-2 mb-3">
                            <label for="regimen"><small class="d-block">¿La propiedad pertence a un régimen de condominio?</small></label>
                            <select name="regimen" id="regimen" class="ab-form background-color rounded border abasto">
                                <option value="1" @isset($regimen) @if($regimen==1) selected @endif @endisset>No</option>
                                <option value="2" @isset($regimen) @if($regimen==2) selected @endif @endisset>Si</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mt-2">
                            ...
                            <input name="numero" id="numero" value="{{((isset($numero))?$numero:'')}}" class="ab-form background-color rounded border numero" type="number" data-parsley-type="number" required>
                        </div>
                        <div class="col-md-3 mt-2">
                            <label for="letraE"><small>Letra exterior</small></label>
                            <input name="letraE" id="letraE" value="{{((isset($letraE))?$letraE:'')}}" class="ab-form background-color rounded border letraE" type="text" style="text-transform: uppercase;" maxlength="5">
                        </div>
                        <div class="col-md-3 mt-2">
                            <label for="interior"><small>Número interior</small></label>
                            <input name="interior" id="interior" value="{{((isset($interior))?$interior:'')}}" class="ab-form background-color rounded border interior" data-parsley-type="number" type="number">
                        </div>
                        <div class="col-md-3 mt-2">
                            <label for="letraI"><small>Letra interior</small></label>
                            <input name="letraI" id="letraI" value="{{((isset($LetraI))?$LetraI:'')}}" class="ab-form background-color rounded border capitalize LetraI" type="text" style="text-transform: uppercase;" maxlength="5">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mt-2">
                        ...
                        <div class="col-md-3 mt-2">
                            ...
                            <input name="manzana" id="manzana" value="{{((isset($manzana))?$manzana:'')}}" class="ab-form background-color rounded border capitalize manzana" type="text" data-parsley-type="number">
                        </div>
                        <div class="col-md-3 mt-2">
                            <label for="lote"><small>Lote</small></label>
                            <input name="lote" id="lote" value="{{((isset($lote))?$lote:'')}}" class="ab-form background-color rounded border capitalize lote" type="text" required>
                        </div>
                    </div>
                    <div class="row regimenCondominio ocultar">
                        <div class="col-md-6 mt-2">
                        ...
                        <div class="col-md-6 mt-2">
                            ...
                            <input name="privativa" id="privativa" value="{{((isset($privativa))?$privativa:'')}}" class="ab-form background-color rounded border capitalize privativa" type="text">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mt-2">
                    ...
                    <div class="row">
                        <div class="col-md-6 mt-2">
                            <label for="cpropiedad"><small>Comprobante de propiedad</small></label>
                            <select name="cpropiedad" id="cpropiedad" class="ab-form background-color rounded border cpropiedad">
                                <option value="">Elija una opción</option>
                                <option value="1" class="escritura">Escritura</option>
                                <option value="2" class="propiedad ">Titulo de propiedad</option>
                                <option value="3" class="contrato">Contrato de compra-venta</option>
                            </select>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4 mt-2 cpropiedadNumero @if(isset($txtcpropiedadNumero) && ($txtcpropiedadNumero != '' || $txtcpropiedadNumero != NULL)) show @else ocultar @endif">
                            <label for="cpropiedadNumero"><small>Número</small></label>
                            <input name="cpropiedadNumero" id="cpropiedadNumero" value="{{((isset($txtcpropiedadNumero)) ? $txtcpropiedadNumero : '')}}" class="ab-form background-color rounded border capitalize txtcpropiedadNumero" data-parsley-type="number" type="text">
                        </div>
                        <div class="col-md-4 mt-2 cpropiedadNotario @if(isset($txtcpropiedadNotario) && ($txtcpropiedadNotario != '' || $txtcpropiedadNotario != NULL)) show @else ocultar @endif">
                            <label for="cpropiedadNotario"><small>Notario número</small></label>
                            <input name="cpropiedadNotario" id="cpropiedadNotario" value="{{((isset($txtcpropiedadNotario)) ? $txtcpropiedadNotario : '')}}" class="ab-form background-color rounded border capitalize txtcpropiedadNotario" data-parsley-type="number" type="text" maxlength="10">
                        </div>
                        <div class="col-md-4 mt-2 cpropiedadMunicipio @if(isset($txtcpropiedadMunicipio) && ($txtcpropiedadMunicipio != '' || $txtcpropiedadMunicipio != NULL)) show @else ocultar @endif">
                            <label for="cpropiedadMunicipio"><small>Municipio</small></label>
                            <input name="cpropiedadMunicipio" id="cpropiedadMunicipio" value="{{((isset($txtcpropiedadMunicipio)) ? $txtcpropiedadMunicipio : '')}}" class="ab-form background-color rounded border capitalize txtcpropiedadMunicipio" type="text">
                        </div>
                        <div class="col-md-4 mt-2 cpropiedadTransmision @if(isset($txtcpropiedadTransmision) && ($txtcpropiedadTransmision != '' || $txtcpropiedadTransmision != NULL)) show @else ocultar @endif">
                            <label for="cpropiedadTransmision"><small>Transmisión patrimonial Recibo número</small></label>
                            <input name="cpropiedadTransmision" id="cpropiedadTransmision" value="{{((isset($txtcpropiedadTransmision)) ? $txtcpropiedadTransmision : '')}}" class="ab-form background-color rounded border capitalize txtcpropiedadTransmision" type="text">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mt-2">
                            <label for="abasto"><small class="d-block">Abasto de agua potable</small></label>
                            <select name="abasto" id="abasto" class="ab-form background-color rounded border abasto">
                                <option value="">Elija una opción</option>
                                <option value="1">Cuenta SIAPA</option>
                                <option value="2">Municipal</option>
                                <option value="3">Propio (Organismo Operador)</option>
                            </select>
                        </div>
                        <div class="col-md-4 mt-2 siapa @if(isset($txtsiapa) && ($txtsiapa != '' || $txtsiapa != NULL)) show @else ocultar @endif ">
                            <label for="siapa"><small>Cuenta SIAPA</small></label>
                            <input name="siapa" id="siapa" value="{{((isset($txtsiapa)) ? Str::of($txtsiapa)->replace('1-', '') : '')}}" id="siapa" class="ab-form background-color rounded border capitalize txtsiapa" type="text">
                        </div>
                    </div>
                    <div class="row mt-4">
                        <div class="col-md-12 mt-2 text-right">
...
<div class="row">
    <div class="col-md-9 mt-4" id="top-5">
        <div class="card  shadow-sm card_5 rounded border-none">
            <div class="card-header">
                <small>Datos del director responsable de obra</small>
            </div>
            <div class="card-body">
                <form id=form_5 method="post">
                    <div class="row">
                        <div class="col-md-6 mt-2">
                            <label for="directorNombre"><small>Nombre</small></label>
                            <input name="directorNombre" id="directorNombre" value="{{((isset($directorNombre)) ? $directorNombre : '')}}" class="ab-form background-color rounded border capitalize directorNombre" type="text" required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mt-2">
                            <label for="directordomicilio"><small>Domicilio</small></label>
                            <input name="directordomicilio" id="directordomicilio" class="ab-form background-color rounded border capitalize directordomicilio" type="text" value="{{((isset($directordomicilio)) ? $directordomicilio : '')}}" required>
                        </div>
                        <div class="col-md-3 mt-2">
                            <label for="directortelefono"><small>Teléfono</small></label>
                            <input name="directortelefono" id="directortelefono" class="ab-form background-color rounded border directortelefono" type="text" value="{{((isset($directortelefono)) ? $directortelefono : '')}}" data-parsley-type="number" data-parsley-minlength="10" maxlength="10" required>
                        </div>
                        <div class="col-md-3 mt-2">
                            <label for="directorRegistro"><small>Registro</small></label>
                            <input name="directorRegistro" id="directorRegistro" class="ab-form background-color rounded border capitalize directorRegistro" type="text" value="{{((isset($directorRegistro)) ? $directorRegistro : '')}}" required>
                        </div>
                    </div>
                    <div class="row mt-4">
                        <div class="col-md-12 mt-2 text-right">
        ...
        <div class="card  shadow-sm card_3 rounded border-none">
            ...
            <div class="card-body">
                <form id=form_3 method="post">
                    ...
                    <div class="row mt-4">
                        <div class="col-md-12 mt-2 text-right">
                            <button data-back=".card_5 .card-body" type="button" class="ab-btn btn-cancel btn-regresar">Regresar</button>
            ...
            <div class="card-body">
                <div class="alert alert-warning alert-dismissible fade show mt-4 notas" role="alert">
                    <h6 class="font">
                        ...
                        <!--@if(isset($id_captura))<a href="https://indicadores.zapopan.gob.mx:8080/tramitesop/solicitudPDFV2.php?t={{$id_captura}}" target="_blank">aquí</a>@endif-->
                ...
                <!--
                <div class="alert alert-warning alert-dismissible fade show" role="alert">
                    <strong class="f-11">Nota:</strong> <small class="f-11"> Debe de adjuntar todos los archivos obligatorios</small>
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                ...
                <form id="form_4" action="{{url('licencia_construccion/ingresa_tramite')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="responsive w-100" style="width: 100%; overflow-x: auto;">
                        <table class="w-100">

                            @foreach($files['terminados'] as $file)
                            <tr class="w-100 predio documento_{{$file->id_documento}}">
                                <td class="f-14">
                                    ...
                                    @elseif ($file->extension == 'dwg' or $file->extension == 'DWG')
                                    <a href="{{ Storage::disk('s3')->url('public/'.session('id_usuario')) }}/{{$file->archivo}}" data-lightbox="roadtrip">
                                        <img class="icono" src="{{asset('media/flaticon/archivos/dwg.svg')}}" width="50px" alt="{{$file->nombre}}">
                                    </a>
                                    @else
                                    <a href="{{ Storage::disk('s3')->url('public/'.session('id_usuario')) }}/{{$file->archivo}}" data-lightbox="roadtrip">
                                ...
                                <td class="f-12 font archivo">{{$file->descripcion_larga}} <br>
                                    ...
                                    @if($file->obligatorio == 1 || ($file->id_documento == 9 && $file->id_tramite == 2))
                                ...
                                <td class="f-14 acciones">
                                    ...
                                    ?>
                                        <label for="{{$file->nombre}}" class="ab-btn-effect bold font btn-file">
                                            ...
                                            <input class="file" id="{{$file->nombre}}" type="file" name="file_{{$file->id_documento}}" data-archivo="{{$file->nombre}}" value="{{$file->nombre}}" data-cat-archivo="{{$file->id_cat_archivo}}" data-update="{{$file->id_archivo}}" data-upload="0" data-required="@if($file->id_documento == 9 && $file->id_tramite == 2) 1 @else {{$file->obligatorio}} @endif">
                                        </label>
                                    <?php
                                    } else {
                                    ?>
                            ...
                            <tr class="w-100 predio documento_{{$file->id_documento}} @if($file->id_documento == 9 && $file->id_tramite == 2) ocultar @endif ">
                                <td class="f-14">
                                ...
                                <td class="f-12 font archivo">{{$file->descripcion_larga}} <br>
                                    ...
                                    <small class="f-10 font text-danger error">Este archivo es obligatorio</small>
                                    @else
                                    <small class="f-10 font text-success error">Este archivo es opcional</small>
                                    @endif
                                </td>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- Si tiene adeudo pone link para pago-->
                <div class="alert alert-warning alert-dismissible fade show mb-3 linkPagoResponsive ocultar" role="alert">
                    <strong class="f-11">Importante:</strong> <small class="f-11">Su cuenta <div class="txtCuenta bold" style="overflow-wrap: break-word;"></div> presenta adeudo predial. Puedes realizar tu pago <a href="https://pagos.zapopan.gob.mx/PagoEnLinea/#/busqueda-del-predio" target="_blank">aquí</a></small>
                </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        @if(isset($id_etapa) && isset($regimen) && ($regimen == 2))
        $('.documento_9').removeClass('ocultar');
        $('.documento_9').find('input').attr('data-required', '1');
        @endif

        @if(isset($id_etapa) && isset($regimen) && ($regimen == 1))
        $('.documento_9').addClass('ocultar');
        $('.documento_9').find('input').attr('data-required', '0');
        @endif

        //Si es cotejo TODO
        @if(isset($id_etapa) && ($id_etapa == 25))
        $('.continuar').fadeOut();
        $('.btn-guardar').fadeOut();
        $('.btn-form3').fadeOut();
        $('.btn-buscar').fadeOut();
        ...
        @if(isset($id_etapa) && ($id_etapa == 20))
        $('.card_1 .card-body').slideUp('slow');
        $('.card_5 .card-body').slideUp('slow');
        $('.card_3 .card-body').slideDown('slow');
        $('.continuar').fadeIn();
        @elseif(isset($id_etapa) && ($id_etapa == 21))
        $('.card_1 .card-body').slideUp('slow');
        $('.card_5 .card-body').slideUp('slow');
        $('.card_4 .card-body').slideDown('slow');
        $('.continuar').fadeIn();
        ...
        $('#cpropiedad').change(function() {


            $('.cpropiedadNumero').addClass('ocultar');
            $('.cpropiedadNotario').addClass('ocultar');
            $('.cpropiedadMunicipio').addClass('ocultar');
            $('.cpropiedadTransmision').addClass('ocultar');
            $('.txtcpropiedadNumero').val('');
            $('.txtcpropiedadNotario').val('');
            $('.txtcpropiedadMunicipio').val('');
            $('.txtcpropiedadTransmision').val('');
            $('.txtcpropiedadNumero').prop('required', false);
            $('.txtcpropiedadNotario').prop('required', false);
            $('.txtcpropiedadMunicipio').prop('required', false);
            $('.txtcpropiedadTransmision').prop('required', false);


            let valor = $('#cpropiedad option:selected').val();

            if (valor == 1) {
                $('.cpropiedadNumero').removeClass('ocultar');
                $('.cpropiedadNotario').removeClass('ocultar');
                $('.cpropiedadMunicipio').removeClass('ocultar');
                $('.txtcpropiedadNumero').prop('required', true);
                $('.txtcpropiedadNotario').prop('required', true);
                $('.txtcpropiedadMunicipio').prop('required', true);
            } else if (valor == 2) {
                $('.cpropiedadNumero').removeClass('ocultar');
                $('.txtcpropiedadNumero').prop('required', true);
            } else if (valor == 3) {
                $('.cpropiedadTransmision').removeClass('ocultar');
                $('.txtcpropiedadTransmision').prop('required', true);
            } else {
                $('.cpropiedadNumero').addClass('ocultar');
                $('.cpropiedadNotario').addClass('ocultar');
                $('.cpropiedadMunicipio').addClass('ocultar');
        ...
        $('#abasto').change(function() {

            $('.siapa').addClass('ocultar');
            $('.txtsiapa').prop('required', false);

            let valor = $('#abasto option:selected').val();

            if (valor == 1) {
                $('.txtsiapa').val('');
                $('.siapa').removeClass('ocultar');
                $('.txtsiapa').prop('required', true);
            } else if (valor == 2) {
                $('.txtsiapa').val('2');
            } else if (valor = 3) {
                $('.txtsiapa').val('3');
        ...
        $('#regimen').change(function() {
            ...
            if ($(this).val() == 2) {
                $('.regimenCondominio').removeClass('ocultar');
                $('.condominio').prop('required', true);
                $('.privativa').prop('required', true);
                $('.documento_9').removeClass('ocultar');
                $('.documento_9').find('input').attr('data-required', '1');
            } else {
                $('.condominio').val('');
                $('.privativa').val('');
                $('.regimenCondominio').addClass('ocultar');
                $('.condominio').prop('required', false);
                $('.privativa').prop('required', false);
                $('.documento_9').addClass('ocultar');
                $('.documento_9').find('input').attr('data-required', '0');
            }
        ...
        $('#form_3').submit(async function(e) {
            ...
            var cpropiedadNumero = $('.txtcpropiedadNumero').val();
            var cpropiedadNotario = $('.txtcpropiedadNotario').val();
            var cpropiedadMunicipio = $('.txtcpropiedadMunicipio').val();
            var cpropiedadTransmision = $('.txtcpropiedadTransmision').val();
            var siapa = $('.txtsiapa').val();

            var directorNombre = $('.directorNombre').val();
            var directordomicilio = $('.directordomicilio').val();
            var directortelefono = $('.directortelefono').val();
            var directorRegistro = $('.directorRegistro').val();
            ...
            if (id_solicitud > 0) {
                ...
                formdata.append('txtcpropiedadNumero', cpropiedadNumero);
                formdata.append('txtcpropiedadNotario', cpropiedadNotario);
                formdata.append('txtcpropiedadMunicipio', cpropiedadMunicipio);
                formdata.append('txtcpropiedadTransmision', cpropiedadTransmision);
                formdata.append('directorNombre', directorNombre);
                formdata.append('directordomicilio', directordomicilio);
                formdata.append('directortelefono', directortelefono);
                formdata.append('directorRegistro', directorRegistro);

                if ($('.txtsiapa').val().trim().length > 0) {
                    formdata.append('txtsiapa', `1-${siapa}`);
                } else {
                    formdata.append('txtsiapa', siapa);
                }

                if (id_etapa == 0) {
                    formdata.append('etapa', 19);
                } else {
                ...
                if ($('#id_captura').val() == "") {
                    ...
                    var res = await axios.post('{{url("licencia_construccion/ingresa_solitud")}}', formdata, {
                        data: {
                            "_token": "{{ csrf_token() }}"
                        }
                    ...
                    var res = await axios.post('{{url("licencia_construccion/actualiza_solitud")}}', formdata, {
                        data: {
                            "_token": "{{ csrf_token() }}"
                        }
                    }).then(function(response) {
        ...
        $('.aqui').click(function() {
            ...
            var url = '{{url("licencia_construccion/carta")}}'
        ...
        //Sección de Datos del Director Responsable de Obra 
                    ...
                    if (typeof(response.msg) != 'undefined') {
                        ...
                        if (response[0].estatus_predio == 'A') {
                           ...
                           /* $('.calle').val(response[0].catcalle_nombre.trim());
                            ...
                            if(response[0].catcalle_nombre){ 
                                $('#calle').val(response[0].catcalle_nombre.trim()); 
                            } 
 
                            if (response[0].catcol_nombre) { 
                                $('.colonia').val(response[0].catcol_nombre.trim()); 
                            } 
                             
                            if(response[0].prenoext){ 
                                $('.numero').val(response[0].prenoext); 
                                $('.numero').prop('readonly', true); 
                            }else{ 
                                $('.numero').prop('readonly', false); 
    ...
    function limpia_predio() {
        ...
        //regresa los select a su estado original 
        $("#regimen").val($("#regimen option:first").val());
        $("#cpropiedad").val($("#cpropiedad option:first").val());
        $("#abasto").val($("#abasto option:first").val());

        //Oculta los input que se generan dinamicamente
        $('.siapa').addClass('ocultar');
        $('.cpropiedadNumero').addClass('ocultar');
        $('.cpropiedadNotario').addClass('ocultar');
        $('.cpropiedadMunicipio').addClass('ocultar');
