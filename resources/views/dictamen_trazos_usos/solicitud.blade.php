...
@section('container')
    <h1 class="text-muted font m-0 bold c-primary-color">
        Dictamen de Trazo, Usos y Destinos Específicos @isset($id_captura)
        @endisset
    </h1>
                        ...
                        <form id="form_2" method="post">
                            <div class="row">
                                <div class="col-md-12 mt-2">
                                    <label for="calle"><small>Calle (Norte)</small></label>
                                    <input name="calle" id="calle" value="{{ isset($calle) ? $calle : '' }}"
                                        class="ab-form background-color rounded border capitalize calle" type="text"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-3 mt-2">
                                    ...
                                    <input name="numero" id="numero" value="{{ isset($numero) ? $numero : '' }}"
                                        class="ab-form background-color rounded border numero" data-parsley-type="number"
                                        required>
                                </div>
                                ...
                                <div class="col-md-3 mt-2">
                                    ...
                                    <input name="interior" id="interior"
                                        value="{{ isset($interior) ? $interior : '' }}"
                                        class="ab-form background-color rounded border capitalize interior"
                                        type="text">
                                </div>

                                <div class="col-md-6 mt-2">
                                    <label for="fraccionamiento"><small>Fraccionamiento/Colonia</small></label>
                                    <input name="fraccionamiento" id="fraccionamiento"
                                        value="{{ isset($fraccionamiento) ? $fraccionamiento : '' }}"
                                        class="ab-form background-color rounded border capitalize fraccionamiento"
                                        type="text">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-3 mt-2">
                                    ...
                                    <input name="manzana" id="manzana" value="{{ isset($manzana) ? $manzana : '' }}"
                                        class="ab-form background-color rounded border capitalize manzana" type="text">
                                </div>
                                <div class="col-md-3 mt-2">
                                    <label for="lote"><small>Lote</small></label>
                                    <input name="lote" id="lote" value="{{ isset($lote) ? $lote : '' }}"
                                        class="ab-form background-color rounded border capitalize lote" type="text">
                                </div>
                                <div class="col-md-6 mt-2">
                                    <label for="condominio"><small>Condominio</small></label>
                                    <input name="condominio" id="condominio"
                                        value="{{ isset($condominio) ? $condominio : '' }}"
                                        class="ab-form background-color rounded border capitalize condominio"
                                        type="text">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 mt-2">
                                    <label for="calle_1"><small>Entre la calle (Oeste)</small></label>
                                    <input name="calle_1" id="calle_1" value="{{ isset($calle_1) ? $calle_1 : '' }}"
                                        class="ab-form background-color rounded border capitalize calle_1" type="text"
                                        required>
                                </div>
                                <div class="col-md-6 mt-2">
                                    <label for="calle_2"><small>Y la calle (Este)</small></label>
                                    <input name="calle_2" id="calle_2" value="{{ isset($calle_2) ? $calle_2 : '' }}"
                                        class="ab-form background-color rounded border capitalize calle_2" type="text"
                                        required>
                                </div>
                                <div class="col-md-6 mt-2">
                                    <label for="calle_3"><small>Calle posterior (Sur)</small></label>
                                    <input name="calle_3" id="calle_3"
                                        value="{{ isset($callePosterior) ? $callePosterior : '' }}"
                                        class="ab-form background-color rounded border capitalize calle_3" type="text">
                                </div>
                                <div class="col-md-6 mt-2">
                                    <label for="superficie"><small>Superficie del terreno en base
                                            escrituras</small></label>
                                    <input name="superficie" id="superficie"
                                        value="{{ isset($superficie) ? $superficie : '' }}"
                                        class="ab-form background-color rounded border capitalize superficie"
                                         data-parsley-minlength="2" maxlength="10"
                                        type="text" required>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mt-2">
                                    <label><small>Uso solicitado</small></label>
                                    <select name="giro" id="giro"
                                        class="ab-form background-color rounded border uso giro" required>
                                        <option value="">Seleccione un uso</option>
                                        @if (isset($giroContruccion) && $giroContruccion== 1)
                                            <option value="Habitacional" selected="selected">Habitacional</option>
                                        @else
                                            <option value="Habitacional">Habitacional</option>
                                        @endif
                                        @if (isset($giroContruccion) && $giroContruccion == 2)
                                            <option value="Habitacional Orizontal" selected="selected">Habitacional
                                                Horizontal</option>
                                        @else
                                            <option value="2">Habitacional Horizontal</option>
                                        @endif

                                        @if (isset($giro) && $giro == 3)
                                            <option value="Habitacional Vertical" selected="selected">Habitacional
                                                Vertical</option>
                                        @else
                                            <option value="Habitacional vertical">Habitacional vertical</option>
                                        @endif
                                        ...
                                        @if (isset($giro) && $giro == 6)
                                            <option value="Subdivisión" selected="selected">Subdivisión</option>
                                        @else
                                            <option value="Subdivisión">Subdivisión</option>
                                        @endif

                                        @if (isset($giro) && $giro == 7)
                                            <option value="Servicios a la Industria" selected="selected">Servicios a la
                                                Industria</option>
                                        @else
                                            <option value="Servicios a la Industria">Servicios a la Industria</option>
                                        @endif

                                        @if (isset($giro) && $giro == 8)
                                            <option value="Equipamiento" selected="selected">Equipamiento</option>
                                        @else
                                            <option value="Equipamiento">Equipamiento</option>
                                        @endif

                                        @if (isset($giro) && $giro == 9)
                                            <option value="Mixto" selected="selected">Mixto</option>
                                        @else
                                            <option value="Mixto">Mixto</option>
                                        @endif

                                        @if (isset($giro) && $giro == 10)
                                            <option value="Turístico Hotelero" selected="selected">Turístico Hotelero
                                            </option>
                                        @else
                                            <option value="Turístico Hotelero">Turístico Hotelero</option>
                                        @endif

                                        @if (isset($giro) && $giro == 11)
                                            <option value="Manufactura Menor" selected="selected">Manufactura Menor
                                            </option>
                                        @else
                                            <option value="Manufactura Menor">Manufactura Menor</option>
                                        @endif

                                        @if (isset($giro) && $giro == 12)
                                            <option value="Manufactura Domiciliaria" selected="selected">Manufactura
                                                Domiciliaria</option>
                                        @else
                                            <option value="Manufactura Domiciliaria">Manufactura Domiciliaria</option>
                                        @endif

                                        @if (isset($giro) && $giro == 13)
                                            <option value="Otros" selected="selected">Otros</option>
                                        @else
                                            <option value="Otros">Otros (especificar en observaciones)
                                        </option>
                                        @endif
                                ...
                                <div class="col-md-6 mt-2">
                                    ...
                                    <input name="observaciones" id="observaciones"
                                        value="{{ isset($observaciones) ? $observaciones : '' }}"
                                        class="ab-form background-color rounded border capitalize observaciones"
                                        type="text" requiered>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-3 mt-2">
                                    <label for="largo"><small>Largo</small></label>
                                    <input name="largo" id="largo" value="{{ isset($largo) ? $largo : '' }}"
                                        class="ab-form background-color rounded border capitalize largo" type="text"
                                        data-parsley-type="number" required>
                                </div>
                                <div class="col-md-3 mt-2">
                                    <label for="ancho"><small>Ancho</small></label>
                                    <input name="ancho" id="ancho" value="{{ isset($ancho) ? $ancho : '' }}"
                                        class="ab-form background-color rounded border capitalize ancho"
                                        data-parsley-type="number" required>
                                </div>
                                <div class="col-md-6 mt-2">
                                    <label for="esquina"><small>Metros a la esquina proxima</small></label>
                                    <input name="esquina" id="esquina" value="{{ isset($esquina) ? $esquina : '' }}"
                                        class="ab-form background-color rounded border capitalize mtsPredioEsquina esquina"
                                        type="text" required>
                                </div>
                            </div>
                            <div class="row mt-4">
                ...
                <div class="card-body">
                    <form id=form_3 method="post">
                        ...
                        <div class="row">
                            <div class="col-md-6 mt-2">
                                ...
                                <input name="nombre" id="nombre"
                                    value="{{ isset($nombre) ? $nombre : (session('nombre') != null ? session('nombre') : (session('razon_social') != null ? session('razon_social') : '')) }}"
                            ...
                            <div class="col-md-3 mt-2">
                                ...
                                <input name="apellido_1" id="apellido_1"
                                    value="{{ isset($apellido_p) ? $apellido_p : '' }}"
                            ...
                            <div class="col-md-3 mt-2">
                                ...
                                <input name="apellido_2" id="apellido_2"
                                    value="{{ isset($apellido_m) ? $apellido_m : '' }}"
                        ...
                        <div class="row">
                            <div class="col-md-12 mt-2">
                                ...
                                <input name="domicilio" id="domicilio"
                                    ...
                                    value="{{ isset($domicilio) ? $domicilio : session('domicilio') }}" maxlength="200">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-8 mt-2">
                                ...
                                <input name="correo_propietario" id="correo_propietario"
                                    ...
                                    value="{{ isset($correo) ? $correo : session('correo') }}" readonly>
                            </div>

                            <div class="col-md-4 mt-2">
                                <label for="telefono"><small>Teléfono</small></label>
                                <input name="telefono" id="telefono"
                                    class="ab-form background-color rounded border telefono" type="text"
                                    value="{{ isset($telefono) ? $telefono : session('telefono') }}"
                                    data-parsley-type="number" data-parsley-minlength="10" maxlength="10" required>
                                <input name="correo" id="correo" type="hidden" value="{{ session('correo') }}">
                                <input name="id_captura" value="{{ isset($id_captura) ? $id_captura : '' }} "
                                    id="id_captura" type="hidden">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 mt-2">
                            <input name="correo" id="correo" type="hidden" value="{{ session('correo') }}">
                            <input name="id_captura" value="{{ isset($id_captura) ? $id_captura : '' }}"
                                id="id_captura" type="hidden" required>
                        </div>
            ...
            <div class="card  shadow-sm card_4 rounded border-none">
                ...
                <div class="card-body">
                    <div class="alert alert-warning alert-dismissible fade show mt-4 notas" role="alert">
                        <h6 class="font">
                            Nota: Debes descargar la solicitud multitramite, firmarla de conformidad y adjuntarla a tus archivos requeridos,
                    ...
                    <form id="form_4" action="{{ url('dictamen_trazos_usos/ingresa_tramite') }}" method="POST"
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#form_3').submit(async function(e) {
                ...
                var calle_3 = $('.calle_3').val();
                var giroContruccion = $('.giro').val();
                var observaciones = $('.observaciones').val();
                var superficie = $('.superficie').val();
                var largo = $('.largo').val();
                var ancho = $('.ancho').val();
                var esquina = $('.esquina').val();
                ...
                if (id_solicitud > 0) {
                    ...
                    formdata.append('calle_3', calle_3);
                    formdata.append('giro', giroContruccion);
                    formdata.append('observaciones', observaciones);
                    formdata.append('superficie', superficie);
                    formdata.append('largo', largo);
                    formdata.append('ancho', ancho);
                    formdata.append('esquina', esquina);
                    ...
                    if ($('#id_captura').val() == ""||!isNaN($('#id_captura').val())) {
                      //  console.log(formdata);
                        var res = await axios.post(
                            '{{ url("dictamen_trazos_usos/ingresa_solicitud") }}',
                            formdata, {
                                data: {
                                    "_token": "{{csrf_token()}}"
                                }
                        ...
                        var res = await axios.post(
                            '{{ url('dictamen_trazos_usos/actualiza_solicitud') }}',
                            formdata, {
                                data: {
                                    "_token": "{{ csrf_token() }}"
                                }
